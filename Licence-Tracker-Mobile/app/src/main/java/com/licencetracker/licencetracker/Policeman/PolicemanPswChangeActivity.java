...
public class PolicemanPswChangeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_policeman_psw_change);
    ...
    private void updatePassword() {
        ...
        if (pswValue.equals("") || cpswValue.equals("")) {
            ...
            Toast.makeText(PolicemanPswChangeActivity.this, "Text boxes are empty", Toast.LENGTH_SHORT).show();

        } else if (!pswValue.equals(cpswValue)) {

            Toast.makeText(PolicemanPswChangeActivity.this, "Password and confirm password not matched!.", Toast.LENGTH_SHORT).show();

        } else {

            try {
                String URL = API.POLICEMAN_API + "password_change";

                RequestQueue requestQueue = Volley.newRequestQueue(PolicemanPswChangeActivity.this);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(PolicemanPswChangeActivity.this, msg, Toast.LENGTH_SHORT).show();
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(PolicemanPswChangeActivity.this, "Some error occur" + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }) {
                    @Override
